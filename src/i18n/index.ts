      ...
      de: {
        translation: {
          ...
          footerLinks: [
            ...
            { label: 'Kontakt', href: 'https://aboelo.de/kontakt' },
            { label: 'Barrierefreiheit', href: 'https://aboelo.de/barrierefreiheitserklaerung' },
          ],
          ...
          cookieBannerAriaLabel: 'Hinweis zu Cookies und Webanalyse',
          cookieBannerTitle: 'Cookies und Auswertung',
          cookieBannerBody:
            'Wir nutzen Google Analytics, um zu verstehen, wie diese Website genutzt wird. Analyse-Cookies werden nur gesetzt, wenn Sie zustimmen. Die Nutzung des Sudokus ist auch ohne Zustimmung möglich.',
          cookieBannerPrivacyLink: 'Datenschutzerklärung',
          cookieBannerReject: 'Nur notwendige',
          cookieBannerAccept: 'Analyse erlauben',
          cookieBannerOpensNewTab: 'öffnet in neuem Tab',
        },
      },
    },
  })
